<?php
    ...
    $metatitle = "Metro Photo Gallery";
    $metadescription = "Metro Photo Gallery by Tony Xing";
...
echo '<a class="thumbnail" href="photo.php?id=' . $thumbnails_Content['id'] . '">'. "\r\n";
...
echo "Photo" . $thumbnails_Content['id'] . ": " . $thumbnails_Content['h1title'] . "\r\n";
